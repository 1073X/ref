...
is identified as the "RSA Data Security, Inc. md5 Message-_digest
Algorithm" in all material mentioning or referencing this software
or this function.

License is also granted to make and use derivative works provided
that such works are identified as "derived from the RSA Data
Security, Inc. md5 Message-_digest Algorithm" in all material
...
void md5::decode(uint32_t output[], const uint8_t input[], md5::size_type len) {
...
// md5 block update operation. Continues an md5 message-_digest
...
// return hex representation of _digest as string
